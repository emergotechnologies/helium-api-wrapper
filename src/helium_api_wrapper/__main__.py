...
@click.option("--file_name", default="hotspot", type=str, help="Defines the name of the file.")
...
@click.option("--file_format", default="pickle", type=str, help="Defines the format for the output file.")
@click.option("--file_name", default="hotspots", type=str, help="Defines the name of the file.")
@click.option("--path", default="./data", type=str, help="Defines the path for the output file.")
@click.version_option(version="0.1")
...
@click.option("--path", default="./data", type=str, help="Defines the path for the output file.")
@click.version_option(version="0.1")
def get_challenges_for_hotspot(address: str, file_format: str, file_name: str, path: str):
    print(f"called get_challenge with address {address}")
    ResultHandler(load_challenges_for_hotspot(address), file_format, file_name, path).write()
...
@click.option("--path", default="./data", type=str, help="Defines the path for the output file.")
@click.version_option(version="0.1")
def get_challenges(n: int, file_format: str, file_name: str, path: str):
